...
1. Tener en cuenta los criterios de revisión.
2. Ofrecer comentarios constructivos que ofrezcan sugerencias y áreas de mejora claras a los participantes.
3. Usar vocabulario positivo y frases afirmativas en lugar de negativas. Por ejemplo, “Este trabajo podría mejorarse considerando lo siguiente: …” en lugar de “Le falta incluir X”).
4. Incluir citas completas o enlaces a información que pueda beneficiar al proyecto propuesto.
5. Usar ejemplos específicos al evaluar el estilo de redacción. Se pueden citar fragmentos de la propuesta.
6. De no estar de acuerdo con la premisa completa del trabajo, favor tener en cuenta el esfuerzo, labor y tiempo invertidos por el participante al exponer su justificación. Las discrepancias sin pruebas no son bienvenidas.
7. Si una propuesta le parece totalmente convincente, por favor, incluir una o dos frases que elogien sus puntos fuertes.
8. La revisión es un diálogo entre el autor, los revisores y el Comité del Programa. Por favor tener en cuenta que pueden solicitarse actualizaciones o enmiendas a su revisión con información adicional. 
